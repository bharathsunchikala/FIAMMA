...
using Fiamma.ApplicationCore.Specifications;
using Fiamma.Web.Features.OrderDetails;
using NSubstitute;
using Xunit;

namespace Fiamma.UnitTests.MediatorHandlers.OrdersTests;
...
public class GetOrderDetails
{
    ...
    {
        var request = new Fiamma.Web.Features.OrderDetails.GetOrderDetails("SomeUserName", 0);
