...
namespace Fiamma.UnitTests.ApplicationCore.Specifications;
...
public class CatalogFilterPaginatedSpecification
{
    ...
    {
        var spec = new Fiamma.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, null, null);
    ...
    {
        var spec = new Fiamma.ApplicationCore.Specifications.CatalogFilterPaginatedSpecification(0, 10, 1, 1);
